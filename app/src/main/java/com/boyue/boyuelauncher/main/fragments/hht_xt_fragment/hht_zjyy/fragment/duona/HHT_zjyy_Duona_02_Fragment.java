...
public class HHT_zjyy_Duona_02_Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_hht_zjyy_duona_02_stub, null);
        initView(rootView);
        return rootView;
    }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        LogUtils.e("tll", "HHT_zjyy_Duona_02_Fragment---onHiddenChanged:" + hidden);
        if (hidden) {
            if (once) {
                once = false;
                ViewStub stub = rootView.findViewById(R.id.duona_02_stub);
                stub.inflate();
                initItemView();
            }
        }
