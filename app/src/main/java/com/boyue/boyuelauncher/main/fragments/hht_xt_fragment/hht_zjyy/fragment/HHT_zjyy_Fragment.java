...
public class HHT_zjyy_Fragment extends Fragment implements View.OnClickListener {
    ...
    public void onAttach(Context context) {
        ...
        this.mNotification_Main = (Notification_Main) context;
    }
    ...
    public void onClick(View v) {
        if (mNotification_Main == null) return;
        int pageId = 0;
        switch (v.getId()) {
            case R.id.hht_xt_zjyy_01_icon:
                pageId = HHT_zjyy_Activity.BONNIE_XIAOBAN;
                mNotification_Main.onChangedPage(pageId);
                break;
    ...
    private Notification_Main mNotification_Main;

    //点击不同的班型，切换到不同的Fragmnet
    public static interface Notification_Main {
