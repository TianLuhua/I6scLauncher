package com.boyue.boyuelauncher.main.fragments.hht_xt_fragment.hht_zjyy.fragment.zhongban;
...
public class HHT_zjyy_zhongban_01_Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_hht_zjyy_zhongban_01_stub, null);
        initView(rootView);
        return rootView;
    }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        LogUtils.e("tll", "HHT_zjyy_zhongban_01_Fragment---onHiddenChanged:" + hidden);
        if (hidden) {
            if (once) {
                once = false;
                ViewStub stub = rootView.findViewById(R.id.zhongban_01_stub);
                stub.inflate();
                initItemView();
            }
        }
