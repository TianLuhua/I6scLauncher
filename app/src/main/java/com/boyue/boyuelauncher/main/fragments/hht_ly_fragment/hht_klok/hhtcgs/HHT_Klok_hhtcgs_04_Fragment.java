...
public class HHT_Klok_hhtcgs_04_Fragment extends ItemBaseFragment {
    ...
    public static HHT_Klok_hhtcgs_04_Fragment newInstance() {
        return new HHT_Klok_hhtcgs_04_Fragment();
    }
    ...
    protected void loadData() {
        ...
        ThreadPoolManager.newInstance().addExecuteTask(new Runnable() {
            ...
            public void run() {
                ...
                //图标
                TypedArray icnos = mContext.getResources().obtainTypedArray(R.array.hht_ly_kalaok_hhtcgs_items_page04_image);
                //图标下的文字
                TypedArray names = mContext.getResources().obtainTypedArray(R.array.hht_ly_kalaok_hhtcgs_items_page04_text);
