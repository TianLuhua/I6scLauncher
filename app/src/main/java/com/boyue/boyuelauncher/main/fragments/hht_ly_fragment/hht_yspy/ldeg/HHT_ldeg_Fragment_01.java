...
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_01;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_02;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_03;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_04;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_05;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_06;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_07;
import static com.boyue.boyuelauncher.Config.BoYueLauncherResource.HHT_LY_YSPY_ldeg_08;

public class HHT_ldeg_Fragment_01 extends ItemBaseFragment {
    ...
    public static HHT_ldeg_Fragment_01 newInstance() {
        return new HHT_ldeg_Fragment_01();
    }

    public HHT_ldeg_Fragment_01() {
        // Required empty public constructor
        videoPathList = new ArrayList<>();
        videoPathList.add(HHT_LY_YSPY_ldeg_01);
        videoPathList.add(HHT_LY_YSPY_ldeg_02);
        videoPathList.add(HHT_LY_YSPY_ldeg_03);
        videoPathList.add(HHT_LY_YSPY_ldeg_04);
        videoPathList.add(HHT_LY_YSPY_ldeg_05);
        videoPathList.add(HHT_LY_YSPY_ldeg_06);
        videoPathList.add(HHT_LY_YSPY_ldeg_07);
        videoPathList.add(HHT_LY_YSPY_ldeg_08);
    }
    ...
    protected void loadData() {
        ...
        ThreadPoolManager.newInstance().addExecuteTask(new Runnable() {
            ...
            public void run() {
                ...
                //图标
                TypedArray icnos = mContext.getResources().obtainTypedArray(R.array.hht_ly_yspy_ldeg_page01_image);
                //图标下的文字
                TypedArray names = mContext.getResources().obtainTypedArray(R.array.hht_ly_yspy_ldeg_page01_text);
