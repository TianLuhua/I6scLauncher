...
public class HHT_LY_ModeImp implements HHT_LY_Mode {
    ...
    public void getItemIcon() {
        ...
        ThreadPoolManager.newInstance().addExecuteTask(new Runnable() {
            ...
            public void run() {
                //图标
                TypedArray icnos = mContext.getResources().obtainTypedArray(R.array.hht_ly_items_image);
                //图标下的文字
                TypedArray names = mContext.getResources().obtainTypedArray(R.array.hht_ly_items_text);
