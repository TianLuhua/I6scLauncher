...
public class HHT_LY_ModeImp implements HHT_LY_Mode {
    ...
    public void getItemIcon() {
        ...
        ThreadPoolManager.newInstance().addExecuteTask(new Runnable() {
            ...
            public void run() {
                //图标
                TypedArray icno =mContext. getResources().obtainTypedArray(R.array.hht_ly_items_image);

                //图标下的文字
                String name[] = mContext.getResources().getStringArray(R.array.hht_ly_items_text);
